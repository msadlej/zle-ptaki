...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ForceSpinBox.setObjectName(u"ForceSpinBox")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ForceLabel.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Force 1% - 100%</p></body></html>", None))
        self.plot.setText(QCoreApplication.translate("MainWindow", u"Hello", None))
        self.AngleLabel.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Angle</p><p>1\u00b0 - 89\u00b0</p></body></html>", None))
    # retranslateUi
